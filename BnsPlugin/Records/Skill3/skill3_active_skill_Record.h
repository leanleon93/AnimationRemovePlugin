...
namespace Data {
#pragma pack(push, 1)
	const struct skill3_active_skill_Record : skill3_Record
	{
		__int8 attribute[4];
__int8 category;
__int8 flowtype;
...
char Pad_sub_0[1];
__int64 campfire;
__int64 dash_attribute;
bool sit_down;
__int8 hostile_type;
char Pad_sub_1[2];
__int64 target_filter;
__int64 gather_range;
__int16 hate;
__int8 toggle;
char Pad_sub_2[1];
__int64 switch_off_id;
__int64 passive_effect[8];
__int64 result_controll;
...
char flow_repeat;
char expanded_flow_repeat_count;
char expanded_flow_repeat_start_flow_step;
char Pad_sub_9[3];
__int64 cancel_flow_repeat_next_skill;
bool occurrence_event_in_exec[5];
bool occurrence_event_in_triggered;
bool occurrence_ui_skill_combo_event_in_exec[5];
char Pad_sub_10[1];
__int64 swing_caster_effect_1[4];
__int64 swing_caster_effect_2[4];
__int64 swing_caster_effect_3[4];
__int64 swing_caster_effect_4[4];
__int64 swing_caster_effect_5[4];
__int64 exec_caster_effect_1[4];
__int64 exec_caster_effect_2[4];
__int64 exec_caster_effect_3[4];
__int64 exec_caster_effect_4[4];
__int64 exec_caster_effect_5[4];
__int64 exec_caster_effect_trigger[4];
...
char Pad_sub_11[2];
__int64 stop_next_skill_critical_hit;
bool stop_skill_result_hit;
char Pad_sub_12[3];
__int64 stop_next_skill_hit;
bool stop_skill_result_parry;
char Pad_sub_13[3];
__int64 stop_next_skill_parry;
bool stop_skill_result_perfect_parry;
char Pad_sub_14[3];
__int64 stop_next_skill_perfect_parry;
bool stop_skill_result_counter;
char Pad_sub_15[3];
__int64 stop_next_skill_counter;
bool stop_skill_result_bounce;
char Pad_sub_16[3];
__int64 stop_next_skill_bounce;
bool stop_skill_result_miss;
char Pad_sub_17[3];
__int64 stop_next_skill_miss;
bool stop_skill_result_dodge;
char Pad_sub_18[3];
__int64 stop_next_skill_dodge;
__int8 perfect_dodge;
char Pad_sub_19[3];
__int64 perfect_dodge_gather_range;
__int32 perfect_dodge_valid_duration[5];
__int64 perfect_dodge_success_effect;
...
char Pad_sub_30[2];
__int64 trigger_effect[8];
__int64 trigger_prev_skill;
__int32 trigger_prev_skill_id;
__int64 succession_prev_skill;
...
char Pad_sub_31[3];
__int64 boss_resistible_skill_message;
...
char Pad_sub_37[1];
union IconRef {struct{__int64 IcontextureId; __int32 IconIndex; };};IconRef ui_recycle_icon;
__int64 ui_recycle_name;
__int64 ui_recycle_description;
...
char attach_bone_exec_step;
char detach_bone_exec_step;
char mesh_hide_exec_step;
char Pad_sub_39[1];
__int32 ui_next_combo;
char combo_start_point_flag;
bool summoned_attack;
bool summoned_is_recall;
bool summoned_is_target_change;
bool summoned_is_target_swoon;
char Pad_sub_40[3];
__int64 ui_show_effect_stack;
bool use_skill_message;
char override_level;
char override_available_level;
char override_group[5];
