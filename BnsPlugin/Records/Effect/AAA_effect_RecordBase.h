...
#pragma pack(push, 1)
	const struct effect_Record : DrEl
	{
	public:
		union Key
		{
...
__int64 event_effect[4];
__int8 second_slot_event_effect_target[4];
__int64 second_slot_event_effect[4];
__int8 third_slot_event_effect_target[4];
__int64 third_slot_event_effect[4];
__int8 fourth_slot_event_effect_target[4];
__int64 fourth_slot_event_effect[4];
...
__int64 description3;
__int64 description4;
__int64 description5;
__int64 description_constellation;
__int8 description2_arg_type[4];
wchar_t* description2_arg_value[4];
__int32 mount_attach_duration;
__int32 mount_detach_duration;
__int64 linker_abnormal;
__int64 linkee_abnormal;
...
__int8 duel_warp;
char Pad9[3];
__int64 attach_notify_message;
__int64 description_item_random_option;
