...
#pragma pack(push, 1)
	...
	public:
		std::any GetField(const wchar_t* fieldName) const {
			...
			if (wcscmp(fieldName, L"item_min_level") == 0) return item_min_level;
			if (wcscmp(fieldName, L"item_min_level_1") == 0) return item_min_level[0];
			if (wcscmp(fieldName, L"item_min_level_2") == 0) return item_min_level[1];
			if (wcscmp(fieldName, L"item_min_level_3") == 0) return item_min_level[2];
			if (wcscmp(fieldName, L"item_min_level_4") == 0) return item_min_level[3];
			if (wcscmp(fieldName, L"item_min_level_5") == 0) return item_min_level[4];
			if (wcscmp(fieldName, L"item_min_level_6") == 0) return item_min_level[5];
			if (wcscmp(fieldName, L"item_min_level_7") == 0) return item_min_level[6];
			if (wcscmp(fieldName, L"item_min_level_8") == 0) return item_min_level[7];
		...
		std::wstring GetFieldAsString(const wchar_t* fieldName) {
			...
			if (wcscmp(fieldName, L"item_min_level_1") == 0) return Data::AnyFieldToStringConverter::ToString(&(item_min_level[0]));
			if (wcscmp(fieldName, L"item_min_level_2") == 0) return Data::AnyFieldToStringConverter::ToString(&(item_min_level[1]));
			if (wcscmp(fieldName, L"item_min_level_3") == 0) return Data::AnyFieldToStringConverter::ToString(&(item_min_level[2]));
			if (wcscmp(fieldName, L"item_min_level_4") == 0) return Data::AnyFieldToStringConverter::ToString(&(item_min_level[3]));
			if (wcscmp(fieldName, L"item_min_level_5") == 0) return Data::AnyFieldToStringConverter::ToString(&(item_min_level[4]));
			if (wcscmp(fieldName, L"item_min_level_6") == 0) return Data::AnyFieldToStringConverter::ToString(&(item_min_level[5]));
			if (wcscmp(fieldName, L"item_min_level_7") == 0) return Data::AnyFieldToStringConverter::ToString(&(item_min_level[6]));
			if (wcscmp(fieldName, L"item_min_level_8") == 0) return Data::AnyFieldToStringConverter::ToString(&(item_min_level[7]));
