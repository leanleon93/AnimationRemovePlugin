...
#pragma pack(push, 1)
	...
	{
	private:
		static std::wstring Get_pose_type_EnumValue(__int8 value);
		static std::wstring Get_dead_abnomal_idle_EnumValue(__int8 value);
	public:
		std::any GetField(const wchar_t* fieldName) const {
			if (wcscmp(fieldName, L"alias") == 0) return alias;
			if (wcscmp(fieldName, L"pose_type") == 0) return pose_type;
			if (wcscmp(fieldName, L"die_anim") == 0) return die_anim;
			if (wcscmp(fieldName, L"dead_abnomal_idle") == 0) return dead_abnomal_idle;
			if (wcscmp(fieldName, L"exhaustion_anim") == 0) return exhaustion_anim;
		...
		std::wstring GetFieldAsString(const wchar_t* fieldName) {
			...
			if (wcscmp(fieldName, L"pose_type") == 0) return Data::AnyFieldToStringConverter::ToString(&pose_type);
			if (wcscmp(fieldName, L"die_anim") == 0) return Data::AnyFieldToStringConverter::ToString(&die_anim);
			if (wcscmp(fieldName, L"dead_abnomal_idle") == 0) return Data::AnyFieldToStringConverter::ToString(&dead_abnomal_idle);
			if (wcscmp(fieldName, L"exhaustion_anim") == 0) return Data::AnyFieldToStringConverter::ToString(&exhaustion_anim);
		...
		void AutoCorrectLookupOffsets(const char* lookupDataPtr) {
			...
			if (reinterpret_cast<std::uintptr_t>(exhaustion_anim) < reinterpret_cast<std::uintptr_t>(lookupDataPtr)) exhaustion_anim = reinterpret_cast<wchar_t*>(const_cast<char*>(lookupDataPtr) + reinterpret_cast<std::uintptr_t>(exhaustion_anim));
		...
		wchar_t* alias;
__int8 pose_type;
std::wstring pose_type_EnumValue() const {return Get_pose_type_EnumValue(pose_type);};
char Pad0[3];
wchar_t* die_anim;
__int8 dead_abnomal_idle;
std::wstring dead_abnomal_idle_EnumValue() const {return Get_dead_abnomal_idle_EnumValue(dead_abnomal_idle);};
char Pad1[3];
