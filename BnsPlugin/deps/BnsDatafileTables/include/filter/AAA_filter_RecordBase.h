...
#pragma pack(push, 1)
	...
	public:
		std::any GetField(const wchar_t* fieldName) const {
			...
			if (wcscmp(fieldName, L"subject") == 0) return subject;
			if (wcscmp(fieldName, L"target") == 0) return target;
			if (wcscmp(fieldName, L"subject2") == 0) return subject2;
			if (wcscmp(fieldName, L"target2") == 0) return target2;
		...
		std::wstring GetFieldAsString(const wchar_t* fieldName) {
			...
			if (wcscmp(fieldName, L"subject") == 0) return Data::AnyFieldToStringConverter::ToString(&subject);
			if (wcscmp(fieldName, L"target") == 0) return Data::AnyFieldToStringConverter::ToString(&target);
			if (wcscmp(fieldName, L"subject2") == 0) return Data::AnyFieldToStringConverter::ToString(&subject2);
			if (wcscmp(fieldName, L"target2") == 0) return Data::AnyFieldToStringConverter::ToString(&target2);
