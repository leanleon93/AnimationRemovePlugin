...
#pragma pack(push, 1)
	struct summonedlevel_Record : DrEl
	{
	private:
	...
	public:
		std::any GetField(const wchar_t* fieldName) const {
			...
			if (wcscmp(fieldName, L"summon_ability_rate_attack_power_creature_min") == 0) return summon_ability_rate_attack_power_creature_min;
			if (wcscmp(fieldName, L"summon_ability_rate_attack_power_creature_max") == 0) return summon_ability_rate_attack_power_creature_max;
			if (wcscmp(fieldName, L"summon_ability_rate_defend_power_creature_value") == 0) return summon_ability_rate_defend_power_creature_value;
			if (wcscmp(fieldName, L"summon_ability_rate_pve_boss_level_npc_attack_power_equip_min") == 0) return summon_ability_rate_pve_boss_level_npc_attack_power_equip_min;
			if (wcscmp(fieldName, L"summon_ability_rate_pve_boss_level_npc_attack_power_equip_max") == 0) return summon_ability_rate_pve_boss_level_npc_attack_power_equip_max;
			if (wcscmp(fieldName, L"summon_ability_rate_pve_boss_level_npc_defend_power_equip_value") == 0) return summon_ability_rate_pve_boss_level_npc_defend_power_equip_value;
			if (wcscmp(fieldName, L"summon_ability_rate_pvp_attack_power_equip_min") == 0) return summon_ability_rate_pvp_attack_power_equip_min;
			if (wcscmp(fieldName, L"summon_ability_rate_pvp_attack_power_equip_max") == 0) return summon_ability_rate_pvp_attack_power_equip_max;
			if (wcscmp(fieldName, L"summon_ability_rate_pvp_defend_power_equip_value") == 0) return summon_ability_rate_pvp_defend_power_equip_value;
			if (wcscmp(fieldName, L"summon_ability_rate_defend_resist_power_creature_value") == 0) return summon_ability_rate_defend_resist_power_creature_value;
			if (wcscmp(fieldName, L"summon_ability_rate_attack_hit_base_percent") == 0) return summon_ability_rate_attack_hit_base_percent;
			if (wcscmp(fieldName, L"summon_ability_rate_attack_hit_value") == 0) return summon_ability_rate_attack_hit_value;
			if (wcscmp(fieldName, L"summon_ability_rate_attack_pierce_value") == 0) return summon_ability_rate_attack_pierce_value;
			if (wcscmp(fieldName, L"summon_ability_rate_attack_critical_base_percent") == 0) return summon_ability_rate_attack_critical_base_percent;
			if (wcscmp(fieldName, L"summon_ability_rate_attack_critical_value") == 0) return summon_ability_rate_attack_critical_value;
			if (wcscmp(fieldName, L"summon_ability_rate_attack_critical_damage_value") == 0) return summon_ability_rate_attack_critical_damage_value;
			if (wcscmp(fieldName, L"summon_ability_rate_defend_critical_base_percent") == 0) return summon_ability_rate_defend_critical_base_percent;
			if (wcscmp(fieldName, L"summon_ability_rate_defend_critical_value") == 0) return summon_ability_rate_defend_critical_value;
			if (wcscmp(fieldName, L"summon_ability_rate_defend_dodge_base_percent") == 0) return summon_ability_rate_defend_dodge_base_percent;
			if (wcscmp(fieldName, L"summon_ability_rate_defend_dodge_value") == 0) return summon_ability_rate_defend_dodge_value;
			if (wcscmp(fieldName, L"summon_ability_rate_defend_parry_base_percent") == 0) return summon_ability_rate_defend_parry_base_percent;
			if (wcscmp(fieldName, L"summon_ability_rate_defend_parry_value") == 0) return summon_ability_rate_defend_parry_value;
			if (wcscmp(fieldName, L"summon_ability_rate_attack_stiff_duration_base_percent") == 0) return summon_ability_rate_attack_stiff_duration_base_percent;
			if (wcscmp(fieldName, L"summon_ability_rate_attack_stiff_duration_value") == 0) return summon_ability_rate_attack_stiff_duration_value;
			if (wcscmp(fieldName, L"summon_ability_rate_defend_stiff_duration_base_percent") == 0) return summon_ability_rate_defend_stiff_duration_base_percent;
			if (wcscmp(fieldName, L"summon_ability_rate_defend_stiff_duration_value") == 0) return summon_ability_rate_defend_stiff_duration_value;
			if (wcscmp(fieldName, L"summon_ability_rate_cast_duration_base_percent") == 0) return summon_ability_rate_cast_duration_base_percent;
			if (wcscmp(fieldName, L"summon_ability_rate_cast_duration_value") == 0) return summon_ability_rate_cast_duration_value;
			if (wcscmp(fieldName, L"summon_ability_rate_defend_physical_damage_reduce_percent") == 0) return summon_ability_rate_defend_physical_damage_reduce_percent;
			if (wcscmp(fieldName, L"summon_ability_rate_defend_force_damage_reduce_percent") == 0) return summon_ability_rate_defend_force_damage_reduce_percent;
			if (wcscmp(fieldName, L"summon_ability_rate_attack_damage_modify_percent") == 0) return summon_ability_rate_attack_damage_modify_percent;
			if (wcscmp(fieldName, L"summon_ability_rate_attack_damage_modify_diff") == 0) return summon_ability_rate_attack_damage_modify_diff;
			if (wcscmp(fieldName, L"summon_ability_rate_defend_damage_modify_percent") == 0) return summon_ability_rate_defend_damage_modify_percent;
			if (wcscmp(fieldName, L"summon_ability_rate_defend_damage_modify_diff") == 0) return summon_ability_rate_defend_damage_modify_diff;
			if (wcscmp(fieldName, L"summon_ability_rate_max_hp") == 0) return summon_ability_rate_max_hp;
			if (wcscmp(fieldName, L"summon_ability_rate_hp_regen") == 0) return summon_ability_rate_hp_regen;
			if (wcscmp(fieldName, L"summon_ability_rate_hp_regen_combat") == 0) return summon_ability_rate_hp_regen_combat;
			if (wcscmp(fieldName, L"summon_ability_rate_abnormal_attack_base_percent") == 0) return summon_ability_rate_abnormal_attack_base_percent;
			if (wcscmp(fieldName, L"summon_ability_rate_abnormal_attack_power_value") == 0) return summon_ability_rate_abnormal_attack_power_value;
			if (wcscmp(fieldName, L"summon_ability_rate_abnormal_defend_base_percent") == 0) return summon_ability_rate_abnormal_defend_base_percent;
			if (wcscmp(fieldName, L"summon_ability_rate_abnormal_defend_power_value") == 0) return summon_ability_rate_abnormal_defend_power_value;
			if (wcscmp(fieldName, L"summon_ability_rate_attack_attribute_value") == 0) return summon_ability_rate_attack_attribute_value;
			if (wcscmp(fieldName, L"summon_ability_rate_attack_attribute_base_percent") == 0) return summon_ability_rate_attack_attribute_base_percent;
			...
			if (wcscmp(fieldName, L"r_summon_ability_rate_defend_strength_creature_value") == 0) return r_summon_ability_rate_defend_strength_creature_value;
			if (wcscmp(fieldName, L"r_summon_ability_rate_attack_precise_creature_value") == 0) return r_summon_ability_rate_attack_precise_creature_value;
			if (wcscmp(fieldName, L"r_summon_ability_rate_attack_aoe_pierce_value") == 0) return r_summon_ability_rate_attack_aoe_pierce_value;
			if (wcscmp(fieldName, L"r_summon_ability_rate_attack_abnormal_hit_base_percent") == 0) return r_summon_ability_rate_attack_abnormal_hit_base_percent;
			if (wcscmp(fieldName, L"r_summon_ability_rate_attack_abnormal_hit_value") == 0) return r_summon_ability_rate_attack_abnormal_hit_value;
			if (wcscmp(fieldName, L"r_summon_ability_rate_defend_abnormal_dodge_base_percent") == 0) return r_summon_ability_rate_defend_abnormal_dodge_base_percent;
			if (wcscmp(fieldName, L"r_summon_ability_rate_defend_abnormal_dodge_value") == 0) return r_summon_ability_rate_defend_abnormal_dodge_value;
			if (wcscmp(fieldName, L"r_summon_ability_rate_support_power_base_percent") == 0) return r_summon_ability_rate_support_power_base_percent;
			if (wcscmp(fieldName, L"r_summon_ability_rate_support_power_value") == 0) return r_summon_ability_rate_support_power_value;
			if (wcscmp(fieldName, L"r_summon_ability_rate_hypermove_power_value") == 0) return r_summon_ability_rate_hypermove_power_value;
		...
		std::wstring GetFieldAsString(const wchar_t* fieldName) {
			...
			if (wcscmp(fieldName, L"summon_ability_rate_attack_power_creature_min") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_attack_power_creature_min);
			if (wcscmp(fieldName, L"summon_ability_rate_attack_power_creature_max") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_attack_power_creature_max);
			if (wcscmp(fieldName, L"summon_ability_rate_defend_power_creature_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_defend_power_creature_value);
			if (wcscmp(fieldName, L"summon_ability_rate_pve_boss_level_npc_attack_power_equip_min") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_pve_boss_level_npc_attack_power_equip_min);
			if (wcscmp(fieldName, L"summon_ability_rate_pve_boss_level_npc_attack_power_equip_max") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_pve_boss_level_npc_attack_power_equip_max);
			if (wcscmp(fieldName, L"summon_ability_rate_pve_boss_level_npc_defend_power_equip_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_pve_boss_level_npc_defend_power_equip_value);
			if (wcscmp(fieldName, L"summon_ability_rate_pvp_attack_power_equip_min") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_pvp_attack_power_equip_min);
			if (wcscmp(fieldName, L"summon_ability_rate_pvp_attack_power_equip_max") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_pvp_attack_power_equip_max);
			if (wcscmp(fieldName, L"summon_ability_rate_pvp_defend_power_equip_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_pvp_defend_power_equip_value);
			if (wcscmp(fieldName, L"summon_ability_rate_defend_resist_power_creature_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_defend_resist_power_creature_value);
			if (wcscmp(fieldName, L"summon_ability_rate_attack_hit_base_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_attack_hit_base_percent);
			if (wcscmp(fieldName, L"summon_ability_rate_attack_hit_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_attack_hit_value);
			if (wcscmp(fieldName, L"summon_ability_rate_attack_pierce_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_attack_pierce_value);
			if (wcscmp(fieldName, L"summon_ability_rate_attack_critical_base_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_attack_critical_base_percent);
			if (wcscmp(fieldName, L"summon_ability_rate_attack_critical_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_attack_critical_value);
			if (wcscmp(fieldName, L"summon_ability_rate_attack_critical_damage_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_attack_critical_damage_value);
			if (wcscmp(fieldName, L"summon_ability_rate_defend_critical_base_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_defend_critical_base_percent);
			if (wcscmp(fieldName, L"summon_ability_rate_defend_critical_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_defend_critical_value);
			if (wcscmp(fieldName, L"summon_ability_rate_defend_dodge_base_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_defend_dodge_base_percent);
			if (wcscmp(fieldName, L"summon_ability_rate_defend_dodge_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_defend_dodge_value);
			if (wcscmp(fieldName, L"summon_ability_rate_defend_parry_base_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_defend_parry_base_percent);
			if (wcscmp(fieldName, L"summon_ability_rate_defend_parry_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_defend_parry_value);
			if (wcscmp(fieldName, L"summon_ability_rate_attack_stiff_duration_base_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_attack_stiff_duration_base_percent);
			if (wcscmp(fieldName, L"summon_ability_rate_attack_stiff_duration_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_attack_stiff_duration_value);
			if (wcscmp(fieldName, L"summon_ability_rate_defend_stiff_duration_base_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_defend_stiff_duration_base_percent);
			if (wcscmp(fieldName, L"summon_ability_rate_defend_stiff_duration_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_defend_stiff_duration_value);
			if (wcscmp(fieldName, L"summon_ability_rate_cast_duration_base_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_cast_duration_base_percent);
			if (wcscmp(fieldName, L"summon_ability_rate_cast_duration_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_cast_duration_value);
			if (wcscmp(fieldName, L"summon_ability_rate_defend_physical_damage_reduce_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_defend_physical_damage_reduce_percent);
			if (wcscmp(fieldName, L"summon_ability_rate_defend_force_damage_reduce_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_defend_force_damage_reduce_percent);
			if (wcscmp(fieldName, L"summon_ability_rate_attack_damage_modify_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_attack_damage_modify_percent);
			if (wcscmp(fieldName, L"summon_ability_rate_attack_damage_modify_diff") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_attack_damage_modify_diff);
			if (wcscmp(fieldName, L"summon_ability_rate_defend_damage_modify_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_defend_damage_modify_percent);
			if (wcscmp(fieldName, L"summon_ability_rate_defend_damage_modify_diff") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_defend_damage_modify_diff);
			if (wcscmp(fieldName, L"summon_ability_rate_max_hp") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_max_hp);
			if (wcscmp(fieldName, L"summon_ability_rate_hp_regen") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_hp_regen);
			if (wcscmp(fieldName, L"summon_ability_rate_hp_regen_combat") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_hp_regen_combat);
			if (wcscmp(fieldName, L"summon_ability_rate_abnormal_attack_base_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_abnormal_attack_base_percent);
			if (wcscmp(fieldName, L"summon_ability_rate_abnormal_attack_power_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_abnormal_attack_power_value);
			if (wcscmp(fieldName, L"summon_ability_rate_abnormal_defend_base_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_abnormal_defend_base_percent);
			if (wcscmp(fieldName, L"summon_ability_rate_abnormal_defend_power_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_abnormal_defend_power_value);
			if (wcscmp(fieldName, L"summon_ability_rate_attack_attribute_value") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_attack_attribute_value);
			if (wcscmp(fieldName, L"summon_ability_rate_attack_attribute_base_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&summon_ability_rate_attack_attribute_base_percent);
			...
			if (wcscmp(fieldName, L"r_summon_ability_rate_defend_strength_creature_value") == 0) return Data::AnyFieldToStringConverter::ToString(&r_summon_ability_rate_defend_strength_creature_value);
			if (wcscmp(fieldName, L"r_summon_ability_rate_attack_precise_creature_value") == 0) return Data::AnyFieldToStringConverter::ToString(&r_summon_ability_rate_attack_precise_creature_value);
			if (wcscmp(fieldName, L"r_summon_ability_rate_attack_aoe_pierce_value") == 0) return Data::AnyFieldToStringConverter::ToString(&r_summon_ability_rate_attack_aoe_pierce_value);
			if (wcscmp(fieldName, L"r_summon_ability_rate_attack_abnormal_hit_base_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&r_summon_ability_rate_attack_abnormal_hit_base_percent);
			if (wcscmp(fieldName, L"r_summon_ability_rate_attack_abnormal_hit_value") == 0) return Data::AnyFieldToStringConverter::ToString(&r_summon_ability_rate_attack_abnormal_hit_value);
			if (wcscmp(fieldName, L"r_summon_ability_rate_defend_abnormal_dodge_base_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&r_summon_ability_rate_defend_abnormal_dodge_base_percent);
			if (wcscmp(fieldName, L"r_summon_ability_rate_defend_abnormal_dodge_value") == 0) return Data::AnyFieldToStringConverter::ToString(&r_summon_ability_rate_defend_abnormal_dodge_value);
			if (wcscmp(fieldName, L"r_summon_ability_rate_support_power_base_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&r_summon_ability_rate_support_power_base_percent);
			if (wcscmp(fieldName, L"r_summon_ability_rate_support_power_value") == 0) return Data::AnyFieldToStringConverter::ToString(&r_summon_ability_rate_support_power_value);
			if (wcscmp(fieldName, L"r_summon_ability_rate_hypermove_power_value") == 0) return Data::AnyFieldToStringConverter::ToString(&r_summon_ability_rate_hypermove_power_value);
...
#pragma pack(push, 1)
	struct __declspec(align(4)) summonedlevel_RecordPtr // : DrRecordPtr
	{
		...
		//__unaligned __declspec(align(1)) const Data::summonedlevel_Record* _debug;
		bool _makeCopy;
	};
#pragma pack(pop)
}