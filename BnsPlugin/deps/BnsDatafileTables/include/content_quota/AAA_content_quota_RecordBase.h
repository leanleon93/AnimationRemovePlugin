...
namespace Data {
    enum class content_quota_RecordSubType : __int32
    {
		...
		content_quota_record_sub_count = 364,
    };
#pragma pack(push, 1)
	...
	private:
		...
		static std::wstring Get_charge_interval_EnumValue(__int8 value);
		static std::wstring Get_charge_day_of_week_EnumValue(__int8 value);
	public:
		std::any GetField(const wchar_t* fieldName) const {
			...
			if (wcscmp(fieldName, L"charge_interval") == 0) return charge_interval;
			if (wcscmp(fieldName, L"charge_day_of_week") == 0) return charge_day_of_week;
			if (wcscmp(fieldName, L"charge_time") == 0) return charge_time;
			if (wcscmp(fieldName, L"charge_amount_per_interval") == 0) return charge_amount_per_interval;
			if (wcscmp(fieldName, L"consume_key_record") == 0) return consume_key_record;
			if (wcscmp(fieldName, L"consume_order") == 0) return consume_order;
			if (wcscmp(fieldName, L"consume_order_1") == 0) return consume_order[0];
			if (wcscmp(fieldName, L"consume_order_2") == 0) return consume_order[1];
			if (wcscmp(fieldName, L"consume_order_3") == 0) return consume_order[2];
			if (wcscmp(fieldName, L"consume_order_4") == 0) return consume_order[3];
		...
		std::wstring GetFieldAsString(const wchar_t* fieldName) {
			...
			if (wcscmp(fieldName, L"charge_interval") == 0) return Data::AnyFieldToStringConverter::ToString(&charge_interval);
			if (wcscmp(fieldName, L"charge_day_of_week") == 0) return Data::AnyFieldToStringConverter::ToString(&charge_day_of_week);
			if (wcscmp(fieldName, L"charge_time") == 0) return Data::AnyFieldToStringConverter::ToString(&charge_time);
			if (wcscmp(fieldName, L"charge_amount_per_interval") == 0) return Data::AnyFieldToStringConverter::ToString(&charge_amount_per_interval);
			if (wcscmp(fieldName, L"consume_key_record") == 0) return Data::AnyFieldToStringConverter::ToString(&consume_key_record);
			if (wcscmp(fieldName, L"consume_order_1") == 0) return Data::AnyFieldToStringConverter::ToString(&(consume_order[0]));
			if (wcscmp(fieldName, L"consume_order_2") == 0) return Data::AnyFieldToStringConverter::ToString(&(consume_order[1]));
			if (wcscmp(fieldName, L"consume_order_3") == 0) return Data::AnyFieldToStringConverter::ToString(&(consume_order[2]));
			if (wcscmp(fieldName, L"consume_order_4") == 0) return Data::AnyFieldToStringConverter::ToString(&(consume_order[3]));
...
std::wstring charge_interval_EnumValue() const {return Get_charge_interval_EnumValue(charge_interval);};
__int8 charge_day_of_week;
std::wstring charge_day_of_week_EnumValue() const {return Get_charge_day_of_week_EnumValue(charge_day_of_week);};
__int8 charge_time;
char Pad1[1];
