...
#pragma pack(push, 1)
	...
	public:
		std::any GetField(const wchar_t* fieldName) const {
			...
			if (wcscmp(fieldName, L"world_account_combination_cost_group") == 0) return world_account_combination_cost_group;
		...
		std::wstring GetFieldAsString(const wchar_t* fieldName) {
			...
			if (wcscmp(fieldName, L"world_account_combination_cost_group") == 0) return Data::AnyFieldToStringConverter::ToString(&world_account_combination_cost_group);
