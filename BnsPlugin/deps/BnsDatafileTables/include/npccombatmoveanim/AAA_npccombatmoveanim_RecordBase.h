...
#pragma pack(push, 1)
	struct npccombatmoveanim_Record : DrEl
	{
	private:
...
#pragma pack(pop)
#pragma pack(push, 1)
	struct __declspec(align(4)) npccombatmoveanim_RecordPtr // : DrRecordPtr
	{
		npccombatmoveanim_Record* _record;
		int _cacheChunkIndex;
		//__unaligned __declspec(align(1)) const Data::npccombatmoveanim_Record* _debug;
		bool _makeCopy;
	};
#pragma pack(pop)
}