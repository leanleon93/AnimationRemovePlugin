...
#pragma pack(push, 1)
	...
	public:
		std::any GetField(const wchar_t* fieldName) const {
			...
			if (wcscmp(fieldName, L"increase_amount") == 0) return increase_amount;
		...
		std::wstring GetFieldAsString(const wchar_t* fieldName) {
			...
			if (wcscmp(fieldName, L"increase_amount") == 0) return Data::AnyFieldToStringConverter::ToString(&increase_amount);
