...
#pragma pack(push, 1)
	...
	public:
		std::any GetField(const wchar_t* fieldName) const {
			...
			if (wcscmp(fieldName, L"recycle_group_modify_time") == 0) return recycle_group_modify_time;
			if (wcscmp(fieldName, L"recycle_group_modify_time_1") == 0) return recycle_group_modify_time[0];
			if (wcscmp(fieldName, L"recycle_group_modify_time_2") == 0) return recycle_group_modify_time[1];
		...
		std::wstring GetFieldAsString(const wchar_t* fieldName) {
			...
			if (wcscmp(fieldName, L"recycle_group_modify_time_1") == 0) return Data::AnyFieldToStringConverter::ToString(&(recycle_group_modify_time[0]));
			if (wcscmp(fieldName, L"recycle_group_modify_time_2") == 0) return Data::AnyFieldToStringConverter::ToString(&(recycle_group_modify_time[1]));
