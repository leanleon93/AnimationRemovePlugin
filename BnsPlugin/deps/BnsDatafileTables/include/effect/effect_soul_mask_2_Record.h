...
#pragma pack(push, 1)
	...
	public:
		std::any GetField(const wchar_t* fieldName) const {
			...
			if (wcscmp(fieldName, L"soul_mask_id") == 0) return soul_mask_id;
		...
		std::wstring GetFieldAsString(const wchar_t* fieldName) {
			...
			if (wcscmp(fieldName, L"soul_mask_id") == 0) return Data::AnyFieldToStringConverter::ToString(&soul_mask_id);
		...
		static __int32 SubType() { return 874; }
	};
#pragma pack(pop)
}