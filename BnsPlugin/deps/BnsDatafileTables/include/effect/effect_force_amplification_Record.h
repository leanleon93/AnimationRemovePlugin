...
#pragma pack(push, 1)
	...
	public:
		std::any GetField(const wchar_t* fieldName) const {
			...
			if (wcscmp(fieldName, L"ability_percent") == 0) return ability_percent;
		...
		std::wstring GetFieldAsString(const wchar_t* fieldName) {
			...
			if (wcscmp(fieldName, L"ability_percent") == 0) return Data::AnyFieldToStringConverter::ToString(&ability_percent);
