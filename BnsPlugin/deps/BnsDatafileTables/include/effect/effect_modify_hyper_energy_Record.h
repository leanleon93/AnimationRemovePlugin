...
#pragma pack(push, 1)
	...
	public:
		std::any GetField(const wchar_t* fieldName) const {
			...
			if (wcscmp(fieldName, L"diff_hyper_energy") == 0) return diff_hyper_energy;
		...
		std::wstring GetFieldAsString(const wchar_t* fieldName) {
			...
			if (wcscmp(fieldName, L"diff_hyper_energy") == 0) return Data::AnyFieldToStringConverter::ToString(&diff_hyper_energy);
