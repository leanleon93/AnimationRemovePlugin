...
namespace Data {
#pragma pack(push, 1)
	struct attendance_board_game_Record : attendance_Record
	{
	private:
	...
	public:
		std::any GetField(const wchar_t* fieldName) const {
			...
			if (wcscmp(fieldName, L"arrive_goal_particle_ref") == 0) return arrive_goal_particle_ref;
			if (wcscmp(fieldName, L"arrive_goal_particle_scale") == 0) return arrive_goal_particle_scale;
			if (wcscmp(fieldName, L"arrive_goal_particle_duration") == 0) return arrive_goal_particle_duration;
			if (wcscmp(fieldName, L"arrive_goal_sound_ref") == 0) return arrive_goal_sound_ref;
			if (wcscmp(fieldName, L"icon_start_imageset") == 0) return icon_start_imageset;
			if (wcscmp(fieldName, L"icon_goal_imageset") == 0) return icon_goal_imageset;
		...
		std::wstring GetFieldAsString(const wchar_t* fieldName) {
			...
			if (wcscmp(fieldName, L"arrive_goal_particle_ref") == 0) return Data::AnyFieldToStringConverter::ToString(&arrive_goal_particle_ref);
			if (wcscmp(fieldName, L"arrive_goal_particle_scale") == 0) return Data::AnyFieldToStringConverter::ToString(&arrive_goal_particle_scale);
			if (wcscmp(fieldName, L"arrive_goal_particle_duration") == 0) return Data::AnyFieldToStringConverter::ToString(&arrive_goal_particle_duration);
			if (wcscmp(fieldName, L"arrive_goal_sound_ref") == 0) return Data::AnyFieldToStringConverter::ToString(&arrive_goal_sound_ref);
			if (wcscmp(fieldName, L"icon_start_imageset") == 0) return Data::AnyFieldToStringConverter::ToString(&icon_start_imageset);
			if (wcscmp(fieldName, L"icon_goal_imageset") == 0) return Data::AnyFieldToStringConverter::ToString(&icon_goal_imageset);
		...
		void AutoCorrectLookupOffsets(const char* lookupDataPtr) {
			...
			if (reinterpret_cast<std::uintptr_t>(arrive_goal_particle_ref) < reinterpret_cast<std::uintptr_t>(lookupDataPtr)) arrive_goal_particle_ref = reinterpret_cast<wchar_t*>(const_cast<char*>(lookupDataPtr) + reinterpret_cast<std::uintptr_t>(arrive_goal_particle_ref));
			if (reinterpret_cast<std::uintptr_t>(arrive_goal_sound_ref) < reinterpret_cast<std::uintptr_t>(lookupDataPtr)) arrive_goal_sound_ref = reinterpret_cast<wchar_t*>(const_cast<char*>(lookupDataPtr) + reinterpret_cast<std::uintptr_t>(arrive_goal_sound_ref));
			...
			if (reinterpret_cast<std::uintptr_t>(icon_goal_imageset) < reinterpret_cast<std::uintptr_t>(lookupDataPtr)) icon_goal_imageset = reinterpret_cast<wchar_t*>(const_cast<char*>(lookupDataPtr) + reinterpret_cast<std::uintptr_t>(icon_goal_imageset));
...
wchar_t* arrive_goal_particle_ref;
float arrive_goal_particle_scale;
float arrive_goal_particle_duration;
wchar_t* arrive_goal_sound_ref;
wchar_t* icon_start_imageset;
wchar_t* icon_goal_imageset;
